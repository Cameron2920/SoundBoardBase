...
public class SoundClipAdapter extends RecyclerView.Adapter {
    ...
    public SoundClipAdapter(List<SoundClip> soundClips, SoundClipCell.Delegate soundClipCellDelegate, int soundClipCellId) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SoundClipCell(LayoutInflater.from(parent.getContext()).inflate(this.soundClipCellId, parent, false), soundClipCellDelegate);
    }
